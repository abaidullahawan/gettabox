...
class GeneralSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create general_setting" do
    assert_difference('GeneralSetting.count') do
      post general_settings_url, params: { general_setting: { address: @general_setting.address, display_name: @general_setting.display_name, name: @general_setting.name, phone: @general_setting.phone } }
    end
  ...
  test "should update general_setting" do
    patch general_setting_url(@general_setting), params: { general_setting: { address: @general_setting.address, display_name: @general_setting.display_name, name: @general_setting.name, phone: @general_setting.phone } }
